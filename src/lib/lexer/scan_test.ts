...
Deno.test("Sanity", () => {
	...
	const expected: TAnyDetectionResult[] = [
		...
		{ category: "MISC", token: "SPACE", value: " ", position: 5 },
		{ category: "MISC", token: "IDENTIFIER", value: "a", position: 6 },
		{ category: "MISC", token: "SPACE", value: " ", position: 7 },
		{ category: "OPERATOR", token: "EQ", value: "=", position: 8 },
		{ category: "MISC", token: "SPACE", value: " ", position: 9 },
...
Deno.test("Sanity 2", () => {
	...
	const expected: TAnyDetectionResult[] = [
		...
		{ category: "MISC", token: "SPACE", value: " ", position: 3 },
